...
<head>
    ...
    <title> Datos de Sensor De temperatura y humedad dht</title>
<style>
...
<body>
    <section class="sec">
        <h1>Datos de Sensor De temperatura y humedad dht</h1>
    <h2>Reporte pdf</h2>
    ...
    <table>
        ...
        <tbody>
            @foreach($Sensor as $turb)
            <tr>
                <td>{{$turb->id}}</td>
            <td>{{$turb->nombre_paciente}}</td>
            <td>{{$turb->temperatura}}</td>
            <td>{{$turb->humedad}}</td>
